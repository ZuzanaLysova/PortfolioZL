...
Na \in{obrázku}[obr:archimate] je zobrazený model aplikačnej architektúry, ktorý popisuje štruktúru, správanie a interakcií v aplikácii. Bol vytvorený pomocou štandardu Archimate, keďže bol pre tieto účely najvhodnejší. Obsahuje rôzne elementy ako procesy, služby, interakcie, rozhrania a podobne.
...
V prípade EA2LIDS sa pracuje so špeciálnym typom diagramu - LIDS7 a toolboxu v EA (viď \in{obrázok}[obr:special-ea]). Pre správne využitie a funkčnosť nástroja je potreba dbať na správnosť modelov - správne vybrané stereotypy, nadefinované dátové typy, správna menná konvencia, tagy atď. Výsledkom je validný model.xml (zjednodušená schéma fungovania je zobrazená na \in{obrázku}[obr:ea2lids]).
...
\pkap{Nástroj AMK}
Platforma SAMO umožňuje vytvárať evidenčné agendové aplikácie, ktoré sa tvoria pomocou konfiguračných metadát. Do týchto metadát sa ukladajú informácie ako dátový model, štruktúra obrazoviek, formulárov atď. Pre účely urýchlenia implementácie SAMO aplikácií bola vyvinutá sada nástrojov označená ako AMK (Application Modling Kit). AMK je koncept a definovaný spôsob práce, súbor metodík a nástrojov, most, ktorý spája analýzu s implementací. Je určený pre agendové aplikácie, teda aplikácie, kde hlavnú úlohu hrá evedincia artefaktov a workflow nad evidenciou. Zaoberá sa spôsobom predávania informácií medzi analýzou a výrobou v štrukturovanej podobe tak, aby štruktúra vyhovovala analytikovi i implementácii. Logika využitia AMK je na \in{obrázku}[obr:amk]. AMK možno popísať ako koncept a definovaný spôsob práce, súbor metodík, most spájajúci analýzu s implementáciou. Na \in{obrázku}[obr:amk-archi] je zobrazený model aplikačnej architektúry AMK.
...
TODO: 
https://assecoce.sharepoint.com/:w:/r/teams/EMMAPEGOV-Analza/_layouts/15/Doc.aspx?sourcedoc=%7B21312F3A-AA11-435B-AFEC-3A266062458F%7D&file=EMMA_E2_Metodika%20v%C3%BDvoje.docx&action=default&mobileredirect=true

Služba, ktorá bola implementovaná je "Oznámení nástupu zaměstnace". Na \in{obrázku}[obr:sekv1]
