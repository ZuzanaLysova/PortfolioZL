...
Počiatočný stav je "neověřeno". Po kliknutí na akciu overenia žiadosti na detaile vybranej žiadosti sa overí žiadosť na rôznych zaujatých orgánoch verejnej správy. 
...
Štvrtý krok obsahuje údajetýkajúce sa zamestnania, ako sú napr. zamestnávateľ, druh pracovného pomeru, pozícia a podobne. Všetky údaje možno vidieť na \in{obrázku}[obr:step4].
...
\bTABLE
  ...
  \bTR
    \bTD as_pravnickaOsoba_zamestnanec \eTD
    \bTD pravnickaOsoba -> zamestnanec \eTD
    \bTD 1:N \eTD
  \eTR
   \bTR
    \bTD as_fyzickaOsoba_zamestnanec \eTD
