...
Diagram aktivít slúži na zobrazenie toku činností v systéme a popisuje use case. Hlavné činnosti, ktorými sa zaoberá tento projekt sú vyobrazené na diagrame na \in{obrázku}[obr:activity].

\obrazekH{obr:activity}
...
Konceptuálny dátový model predstavuje pri modelovaní SAMO aplikácie prvý krok k vybudovaniu finálneho dátového modelu. Ide o zjednodušenú ukážku existujúcich entít a väzieb medzi nimi. KDM projektu je na \in{obrázku}[obr:kdm]
